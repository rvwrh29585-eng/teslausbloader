// Centralized icon components for Tesla USB Loader
// Extracted during code review to eliminate ~27 duplicate inline SVG definitions.
...
// Alias used in a couple places
export const LoadingIcon = LoadingSpinner;
...
// Play / Pause (filled style used across cards)
...
// Heart with optional filled state (used in SoundCard)
...
// Simple outline heart (for tabs/filters when not filled state)
